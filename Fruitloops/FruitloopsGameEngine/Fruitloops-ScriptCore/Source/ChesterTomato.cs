/******************************************************************************
/*!
\file  ChesterTomato.cs
\Proj name  Shroomy Doomy
\author  
\date    March 14, 2025
\brief  Implements the ChesterTomato class, a behavior component for managing an interactive
        tomato treasure chest entity that adds "tomato" to the inventory when clicked.
...
{
    /**
     * @brief Manages a tomato treasure chest entity with button-like behavior.
     * 
     * @note Handles chest interaction, adding "tomato" to the inventory when clicked
     * by the player when adjacent, updating the chest's texture, and playing a sound.
     * Inherits from BehaviourComponent.
     */
    public class ChesterTomato : BehaviourComponent
    {
        ...
        /**
         * @brief Default constructor for ChesterTomato.
         */
        public ChesterTomato() { }

        /**
         * @brief Constructs a ChesterTomato instance for a specific entity.
         * 
         ...
         */
        public ChesterTomato(Entity entity)
        {
            Debug.LogInfo("[ChesterTomato] Creating for entity {0}", entity.ID);

            if (!entity.HasLocalComponent<ButtonComponent>())
            {
                Debug.LogInfo("[ChesterTomato] Adding ButtonComponent to entity {0}", entity.ID);
        ...
        /**
         * @brief Creates a new ChesterTomato behavior instance for an entity.
         * 
         * @param entity The Entity to associate with the chest behavior.
         * @return A new ChesterTomato instance, or null if an exception occurs.
        ...
        public static BehaviourComponent CreateBehaviour(Entity entity)
        {
            try
            {
                Debug.LogInfo("[ChesterTomato] [CreateBehaviour] Starting for entity {0}", entity.ID);
                return new ChesterTomato(entity);
            }
            catch (Exception ex)
            {
                Debug.LogError("[ChesterTomato] [CreateBehaviour] Exception: {0}", ex.Message);
                return null;
            }
        }

        /**
         * @brief Initializes the ChesterTomato behavior for an entity.
         * 
        ...
        {
            Debug.LogInfo("[ChesterTomato] Initializing for entity {0}", entity.ID);
            isopenchest = false;
        }
         ...
         * @note Handles hover detection, click processing to open the chest, adds "tomato" to
        ...
        {
            var button = GameLogicSystem.Instance.GetBehaviour<ChesterTomato>(entity);
            if (button == null || button._buttonComponent == null)
            {
                Debug.LogWarning("[ChesterTomato] ButtonComponent is null for entity {0}.", entity.ID);
                return;
            }
            ...
            try
            {
                ...
                ulong chestID = InternalCalls.Entity_GetEntityByName("ChesterTomato");
                ...
                if (Entity_IsAdjacent(playerID, chestID, tileSize))
                {
                    if (Input.IsMouseButtonDown(0) && button._buttonComponent.IsHovered && !button._clickProcessed)
                    {
                        ...
                        {
                            Debug.LogInfo("[ChesterTomato] Button clicked on entity {0}", entity.ID);
                            InventorySystem.Instance?.AddItem("tomato"); // Call the AddItem function
                            ...
                            InternalCalls.SetEntityTextureByID(entity.ID, "tomato_treasure_chest");
                            ...
                            InternalCalls.SetChestOverlayTrigger("ChesterTomatoTime");
            ...
            {
                Debug.LogError("[ChesterTomato] Error during update: {0}", ex.Message);
            }
        }

        /**
         * @brief Cleans up the ChesterTomato behavior.
         * 
         * @param entity The Entity associated with the chest behavior.
        ...
        public static void End(Entity entity)
        {
            ...
            Debug.LogInfo("[ChesterTomato] Cleanup complete for entity {0}.", entity.ID);
        }
        ...
        private static bool Input_IsMouseOverEntity(ulong entityID)
        {
            ...
            {
                Debug.LogError("[ChesterTomato] Entity {0} missing Transform: {1}", entityID, ex.Message);
                return false;
            }
