/******************************************************************************
/*!
\file  Crafting_Slot_2.cs
\Proj name  Shroomy Doomy
\author  Ming Sheng
\date    March 14, 2025
\brief  Implements the Crafting_Slot_2 class, a behaviour component that handles
        cycling through inventory items for crafting slot two (selecting next or previous item).
...
{
    /**
     * @brief Manages the second crafting slot for cycling through inventory items.
     * 
     * @note Handles left-click to select the next item and right-click to select the previous
     * item in the inventory for crafting slot two, using a button-like interface.
     * Inherits from BehaviourComponent.
     */
    public class Crafting_Slot_2 : BehaviourComponent
    {
        ...
        /**
         * @brief Default constructor for Crafting_Slot_2.
         */
        public Crafting_Slot_2() { }

        /**
         * @brief Constructs a Crafting_Slot_2 instance for a specific entity.
         * 
         ...
         */
        public Crafting_Slot_2(Entity entity)
        {
            Debug.LogInfo("[Crafting_Slot_2] Creating for entity {0}", entity.ID);

            if (!entity.HasLocalComponent<ButtonComponent>())
            {
                Debug.LogInfo("[Crafting_Slot_2] Adding ButtonComponent to entity {0}", entity.ID);
        ...
        /**
         * @brief Creates a new Crafting_Slot_2 behavior instance for an entity.
         * 
         * @param entity The Entity to associate with the crafting slot behavior.
         * @return A new Crafting_Slot_2 instance, or null if an exception occurs.
        ...
        public static BehaviourComponent CreateBehaviour(Entity entity)
        {
            try
            {
                Debug.LogInfo("[Crafting_Slot_2] [CreateBehaviour] Starting for entity {0}", entity.ID);
                return new Crafting_Slot_2(entity);
            }
            catch (Exception ex)
            {
                Debug.LogError("[Crafting_Slot_2] [CreateBehaviour] Exception: {0}", ex.Message);
                return null;
            }
        }

        /**
         * @brief Initializes the Crafting_Slot_2 behavior for an entity.
         * 
        ...
        {
            Debug.LogInfo("[Crafting_Slot_2] Initializing for entity {0}", entity.ID);
        }
         ...
         * (previous item) to cycle through inventory items for slot two.
         */
        public static void Update(Entity entity, float deltaTime)
        {
            var button = GameLogicSystem.Instance.GetBehaviour<Crafting_Slot_2>(entity);
            if (button == null || button._buttonComponent == null)
            {
                Debug.LogWarning("[Crafting_Slot_2] ButtonComponent is null for entity {0}.", entity.ID);
                return;
            }
            ...
            try
            {
                ...
                {
                    Debug.LogInfo("[Crafting_Slot_2] Left Button clicked on entity {0}", entity.ID);
                ...
                {
                    Debug.LogInfo("[Crafting_Slot_2] Right Button clicked on entity {0}", entity.ID);
            ...
            {
                Debug.LogError("[Crafting_Slot_2] Error during update: {0}", ex.Message);
            }
        }

        /**
         * @brief Cleans up the Crafting_Slot_2 behavior.
         * 
         * @param entity The Entity associated with the crafting slot behavior.
        ...
        public static void End(Entity entity)
        {
            ...
            Debug.LogInfo("[Crafting_Slot_2] Cleanup complete for entity {0}.", entity.ID);
        }
        ...
        private static bool Input_IsMouseOverEntity(ulong entityID)
        {
            ...
            {
                Debug.LogError("[Crafting_Slot_2] Entity {0} missing Transform: {1}", entityID, ex.Message);
                return false;
            }
