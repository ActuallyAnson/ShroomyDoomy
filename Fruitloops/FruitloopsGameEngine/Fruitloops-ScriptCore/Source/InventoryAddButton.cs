/******************************************************************************
/*!
\file  InventoryAddButton.cs
\Proj name  Shroomy Doomy
\author  Ming Sheng
\date    Feb 03, 2024
\brief  This file implements the InventoryAddButton class, a behaviour component that
...
namespace FruitLoops
{
     ...
     *
     * The InventoryAddButton listens for mouse input over its associated entity's button.
     * When clicked, it calls the InventoryManager's AddItem method to add an item ("tomato").
     */
    public class InventoryAddButton : BehaviourComponent
    {
        private ButtonComponent _buttonComponent;
        private bool _clickProcessed = false;

        public InventoryAddButton() { }

        /**
         * @brief Constructs a new InventoryAddButton behaviour for the specified entity.
         *
         ...
         */
        public InventoryAddButton(Entity entity)
        {
            Debug.LogInfo("[InventoryAddButton] Creating for entity {0}", entity.ID);

            if (!entity.HasLocalComponent<ButtonComponent>())
            {
                Debug.LogInfo("[InventoryAddButton] Adding ButtonComponent to entity {0}", entity.ID);
        ...
        /**
         * @brief Factory method to create an InventoryAddButton behaviour.
         *
         ...
         * @return A new InventoryAddButton instance as a BehaviourComponent, or null if an exception occurs.
         */
        public static BehaviourComponent CreateBehaviour(Entity entity)
        {
            try
            {
                Debug.LogInfo("[InventoryAddButton] [CreateBehaviour] Starting for entity {0}", entity.ID);
                return new InventoryAddButton(entity);
            }
            catch (Exception ex)
            {
                Debug.LogError("[InventoryAddButton] [CreateBehaviour] Exception: {0}", ex.Message);
                return null;
            }
        }

        /**
         * @brief Initialization function for the InventoryAddButton behaviour.
         *
        ...
        {
            Debug.LogInfo("[InventoryAddButton] Initializing for entity {0}", entity.ID);
        }

        /**
         * @brief Update function called every frame for the InventoryAddButton behaviour.
         *
        ...
        {
            var button = GameLogicSystem.Instance.GetBehaviour<InventoryAddButton>(entity);
            if (button == null || button._buttonComponent == null)
            {
                Debug.LogWarning("[InventoryAddButton] ButtonComponent is null for entity {0}.", entity.ID);
                return;
            }
            ...
            try
            {
                ...
                {
                    Debug.LogInfo("[InventoryAddButton] Button clicked on entity {0}", entity.ID);
            ...
            {
                Debug.LogError("[InventoryAddButton] Error during update: {0}", ex.Message);
            }
        }

        /**
         * @brief Cleanup function for the InventoryAddButton behaviour.
         *
        ...
        public static void End(Entity entity)
        {
            ...
            Debug.LogInfo("[InventoryAddButton] Cleanup complete for entity {0}.", entity.ID);
        }
        ...
        private static bool Input_IsMouseOverEntity(ulong entityID)
        {
            ...
            {
                Debug.LogError("[InventoryAddButton] Entity {0} missing Transform: {1}", entityID, ex.Message);
                return false;
            }
