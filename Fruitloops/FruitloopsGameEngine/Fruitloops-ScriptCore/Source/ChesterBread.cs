/******************************************************************************
/*!
\file  ChesterBread.cs
\Proj name  Shroomy Doomy
\author  Ming Sheng
\date    March 14, 2025
\brief  Implements the ChesterBread class, a behavior component for managing an interactive
        bread treasure chest entity that adds "bread" to the inventory when clicked.
...
{
    /**
     * @brief Manages a bread treasure chest entity with button-like behavior.
     * 
     * @note Handles chest interaction, adding "bread" to the inventory when clicked
     * by the player when adjacent, updating the chest's texture, and playing a sound.
     * Inherits from BehaviourComponent.
     */
    public class ChesterBread : BehaviourComponent
    {
        ...
        /**
         * @brief Default constructor for ChesterBread.
         */
        public ChesterBread() { }

        /**
         * @brief Constructs a ChesterBread instance for a specific entity.
         * 
         ...
         */
        public ChesterBread(Entity entity)
        {
            Debug.LogInfo("[ChesterBread] Creating for entity {0}", entity.ID);

            if (!entity.HasLocalComponent<ButtonComponent>())
            {
                Debug.LogInfo("[ChesterBread] Adding ButtonComponent to entity {0}", entity.ID);
        ...
        /**
         * @brief Creates a new ChesterBread behavior instance for an entity.
         * 
         * @param entity The Entity to associate with the chest behavior.
         * @return A new ChesterBread instance, or null if an exception occurs.
        ...
        public static BehaviourComponent CreateBehaviour(Entity entity)
        {
            try
            {
                Debug.LogInfo("[ChesterBread] [CreateBehaviour] Starting for entity {0}", entity.ID);
                return new ChesterBread(entity);
            }
            catch (Exception ex)
            {
                Debug.LogError("[ChesterBread] [CreateBehaviour] Exception: {0}", ex.Message);
                return null;
            }
        }

        /**
         * @brief Initializes the ChesterBread behavior for an entity.
         * 
        ...
        {
            Debug.LogInfo("[ChesterBread] Initializing for entity {0}", entity.ID);
            isopenchest = false;
        }
         ...
         * @note Handles hover detection, click processing to open the chest, adds "bread" to
        ...
        {
            var button = GameLogicSystem.Instance.GetBehaviour<ChesterBread>(entity);
            if (button == null || button._buttonComponent == null)
            {
                Debug.LogWarning("[ChesterBread] ButtonComponent is null for entity {0}.", entity.ID);
                return;
            }
            ...
            try
            {
                ...
                ulong chestID = InternalCalls.Entity_GetEntityByName("ChesterBread");
                ...
                if (Entity_IsAdjacent(playerID, chestID, tileSize))
                {
                    if (Input.IsMouseButtonDown(0) && button._buttonComponent.IsHovered && !button._clickProcessed)
                    {
                        ...
                        {
                            Debug.LogInfo("[ChesterBread] Button clicked on entity {0}", entity.ID);
                            InventorySystem.Instance?.AddItem("bread"); // Call the AddItem function
                            ...
                            InternalCalls.SetEntityTextureByID(entity.ID, "BreadTreasure");
                            ...
                            InternalCalls.SetChestOverlayTrigger("ChesterBreadTime");
            ...
            {
                Debug.LogError("[ChesterBread] Error during update: {0}", ex.Message);
            }
        }

        /**
         * @brief Cleans up the ChesterBread behavior.
         * 
         * @param entity The Entity associated with the chest behavior.
        ...
        public static void End(Entity entity)
        {
            ...
            Debug.LogInfo("[ChesterBread] Cleanup complete for entity {0}.", entity.ID);
        }
        ...
        private static bool Input_IsMouseOverEntity(ulong entityID)
        {
            ...
            {
                Debug.LogError("[ChesterBread] Entity {0} missing Transform: {1}", entityID, ex.Message);
                return false;
            }
